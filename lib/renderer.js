...
${bodyHtml}
  ...
  (() => {
    ...
    tuningStyle.textContent = [
      ...
      '.resume-document.renderer-split-sidebar .dsh-resume-page-content,.resume-document.renderer-sidebar-signal .dsh-resume-page-content{display:grid !important;grid-template-columns:minmax(0,' + Math.max(0.55, 1 - template.layout.sidebarRatio) + 'fr) minmax(0,' + template.layout.sidebarRatio + 'fr) !important;gap:' + template.layout.columnGap + 'px !important;align-content:start;}',
      '.resume-document.renderer-split-sidebar .header-block,.resume-document.renderer-sidebar-signal .header-block{grid-column:1 / -1;}',
      '.resume-document.renderer-split-sidebar .dsh-column-main-item,.resume-document.renderer-sidebar-signal .dsh-column-main-item{grid-column:1;min-width:0;}',
      '.resume-document.renderer-split-sidebar .dsh-column-side-item,.resume-document.renderer-sidebar-signal .dsh-column-side-item{grid-column:2;min-width:0;}',
