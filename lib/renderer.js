...
${bodyHtml}
  ...
  (() => {
    ...
    tuningStyle.textContent = [
      ...
      '.resume-document.template-technical .resume-sheet-content{border-left:8px solid ' + template.visual.accentColor + ' !important;}',
      ...
      '.resume-document.template-editorial .resume-module > h2{display:inline-block;padding:4px 10px;border:0 !important;background:' + template.visual.accentColor + '12;}',
      '.resume-document.template-terminal .resume-sheet-content{background:linear-gradient(90deg,#fff 0,#fff 96%,#f1f5f9 96%) !important;}',
      '.resume-document.template-terminal .header-block{border-bottom:2px solid ' + template.visual.accentColor + ' !important;}',
      '.resume-document.template-terminal .resume-module > h2{letter-spacing:.08em;text-transform:uppercase;border-bottom:0 !important;}',
    ].join('');
