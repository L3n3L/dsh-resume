...
export function buildPreviewDocument({ title, bodyHtml, cssText, sourcePath, templatePath, previewPath, previewRoot, renderId, contentHash, templateSpec, layoutSpec = null }) {
