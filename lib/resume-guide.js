export const RESUME_GUIDE_VERSION = '1.1.0'
...
const GUIDE_SECTIONS = {
  ...
  contentBudget: {
    ...
    projects: '最强且最相关的项目通常 2–3 条要点；次要项目 1–2 条。优先保留个人负责范围、技术难点、产出和可验证结果。',
...
export function getResumeGuide(topic = 'all') {
  const allowed = new Set(['workflow', 'modes', 'priorities', 'contentBudget', 'content', 'layout', 'icons', 'permissions'])
