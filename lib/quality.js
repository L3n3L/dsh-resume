...
export function resumeQualityCheck(content, options = {}) {
  ...
  return {
    ...
    target: `校园求职：可读性优先，${targetPages} 页为软目标`,
    writingGuidance: {
      priority: ['证据有依据的职业化强化表达', '目标岗位相关性', 'HR 扫描清晰度', '可读性', '页数', '装饰'],
      evidenceRule: '先保留背景、个人负责范围、动作、方法/技术、结果/指标、产物/链接等证据原子，再压缩或改写。',
      budget: {
        primaryExperienceBullets: '3–5',
        secondaryExperienceBullets: '1–3',
        primaryProjectBullets: '2–3',
        secondaryProjectBullets: '1–2',
        renderedBulletLines: '通常 1–2 行',
      },
      pageRule: '一页是校招偏好；只有在证据完整且可读时才优先一页。',
    },
    sections,
