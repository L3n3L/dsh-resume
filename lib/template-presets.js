...
const PRESETS = [
  ...
  },
  {
    ...
    id: 'swiss-grid',
    name: '瑞士网格',
    description: '大标题、严格网格和极简分隔，适合技术与设计岗位',
    tags: ['网格', '极简', '高对比'],
    layout: { ...TEMPLATE_DEFAULTS.layout, density: 'standard', moduleOrder: ['profile', 'projects', 'skills', 'experience', 'education'] },
  ...
  },
  {
    ...
    name: '午夜终端',
    description: '深色页面、等宽字体和青色信号，适合工程与开发岗位',
    tags: ['深色', '终端', '工程'],
  ...
  },
  {
    ...
    id: 'editorial-serif',
    name: '编辑衬线',
    description: '衬线标题、轻量色块和杂志式节奏，适合产品与内容岗位',
    tags: ['衬线', '杂志感', '产品'],
    layout: { ...TEMPLATE_DEFAULTS.layout, density: 'airy', moduleOrder: ['profile', 'experience', 'projects', 'education', 'skills'] },
    typography: { ...TEMPLATE_DEFAULTS.typography, fontFamily: 'serif', fontSize: 14, headingScale: 1.3, lineHeight: 1.68 },
    spacing: { ...TEMPLATE_DEFAULTS.spacing, pageMargin: 56, sectionGap: 24, paragraphGap: 7 },
  ...
  },
  {
    ...
    id: 'portfolio-cards',
    name: '项目卡片',
    description: '用卡片、指标和标签突出项目成果，适合项目型候选人',
    tags: ['卡片', '成果指标', '项目型'],
    layout: { ...TEMPLATE_DEFAULTS.layout, mode: 'two-column', density: 'standard', moduleOrder: ['profile', 'projects', 'experience', 'skills', 'links'], sidebarRatio: 0.29, columnGap: 18 },
    ...
    visual: { ...TEMPLATE_DEFAULTS.visual, accentColor: '#7c3aed', textColor: '#312e81', mutedColor: '#6d5b9b', backgroundColor: '#fbfaff', divider: 'solid', cornerRadius: 10, variant: 'editorial' },
  },
  {
    ...TEMPLATE_DEFAULTS,
    id: 'academic-paper',
    name: '学术论文',
    description: '克制的论文式排版，优先展示教育、研究和成果',
    tags: ['论文式', '科研', '教育优先'],
    layout: { ...TEMPLATE_DEFAULTS.layout, density: 'standard', moduleOrder: ['profile', 'education', 'projects', 'experience', 'awards', 'skills'] },
    typography: { ...TEMPLATE_DEFAULTS.typography, fontFamily: 'serif', fontSize: 13, headingScale: 1.18, lineHeight: 1.58 },
    spacing: { ...TEMPLATE_DEFAULTS.spacing, pageMargin: 50, sectionGap: 18, paragraphGap: 4 },
    family: 'editorial-quiet',
    renderer: 'academic',
    visual: { ...TEMPLATE_DEFAULTS.visual, accentColor: '#334155', textColor: '#1e293b', mutedColor: '#64748b', backgroundColor: '#ffffff', divider: 'dashed', cornerRadius: 0, variant: 'editorial' },
  },
  {
    ...TEMPLATE_DEFAULTS,
    id: 'sidebar-signal',
    name: '侧栏信号',
    description: '深色信息侧栏加白色主栏，快速建立明确的视觉重心',
    tags: ['侧栏', '强重心', '信息优先'],
  ...
  },
  {
    ...
    name: '商务时间线',
    description: '深色信息顶栏、金色强调和竖向时间线，适合工作经历与项目成果较丰富的候选人',
    tags: ['商务', '时间线', '项目履历'],
...
const FAMILY_BY_PRESET = {
  ...
  'swiss-grid': 'campus-clear',
  'midnight-terminal': 'mono-terminal',
  'editorial-serif': 'editorial-quiet',
  'portfolio-cards': 'portfolio-grid',
  'academic-paper': 'editorial-quiet',
  'sidebar-signal': 'split-focus',
  'business-timeline': 'business-timeline',
}

const RENDERER_BY_PRESET = {
  'campus-standard': 'clean-single',
  'tech-compact': 'technical-timeline',
  'quiet-editorial': 'editorial',
  'mono-terminal': 'technical-timeline',
  'split-sidebar': 'split-sidebar',
  'engineering-timeline': 'technical-timeline',
  'portfolio-grid': 'portfolio-grid',
  'product-signal': 'editorial',
