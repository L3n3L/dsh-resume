const ACTIVE_RENDERER_IDS = Object.freeze(['composition'])

// Kept as a compatibility boundary for old workspace templates and migration.
// They are not part of the active catalog or AI template contract.
const LEGACY_RENDERER_IDS = Object.freeze([
  'clean-single',
  'split-sidebar',
  'technical-timeline',
  'portfolio-grid',
...
export function listRendererIds() {
  return [...ACTIVE_RENDERER_IDS]
}

export function listLegacyRendererIds() {
  return [...LEGACY_RENDERER_IDS]
}
