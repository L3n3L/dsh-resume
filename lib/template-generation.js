import { COMPOSITION_OPTIONS, normalizeTemplateSpec, validateCssText, validateTemplateSpec, TEMPLATE_DEFAULTS } from './template-schema.js'
...
export function generateTemplateCandidate(input = {}) {
  ...
  return {
    ...
    rationale: [
      ...
      `使用通用结构 Renderer，差异由 composition 与独立 CSS 承载`,
