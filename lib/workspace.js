...
const DEMO_RESUME = [
  ...
  '',
  '- GPA：3.8 / 4.0，专业前 10%',
  '- 主修：数据结构、计算机网络、操作系统、数据库原理',
  '- 校园经历：技术社团负责人，组织 6 次前端分享',
  '',
  '## 专业技能',
  '',
  '- 语言：JavaScript / TypeScript / Python',
  '- 前端：React、Vue、Vite、HTML5、CSS3、响应式布局',
  '- 工程：Node.js、Git、Linux、Vitest、Chrome DevTools',
  '- 其他：REST API、SSE、SQL、基础性能优化与测试',
  '',
  '## 项目经历',
  '',
  '### 校园服务平台 · 前端负责人',
  '2025.01 - 2025.06',
  '',
  '- 负责从需求拆解到上线的前端实现，搭建 React + TypeScript 页面和组件体系',
  '- 使用 SSE 实现任务进度实时反馈，首屏加载耗时降低 35%',
  '- 补充 Vitest 单元测试和异常状态，核心流程通过率达到 99%',
  '',
  '### 数据看板 · 核心成员',
  '2024.09 - 2024.12',
  '',
  '- 设计可复用的筛选、表格和图表模块，支持 20 万条记录分页查询',
  '- 通过虚拟列表和请求缓存减少重复渲染，页面交互响应时间降低 40%',
  '',
  '## 实习经历',
  '',
  '### 某某科技 · 前端开发实习生',
  '2025.07 - 2025.09',
  '',
  '- 参与内部运营工具建设，完成 8 个业务页面和 12 个通用组件',
  '- 与后端协作定义接口和错误态，减少联调返工并完善上线检查清单',
  '- 根据埋点和反馈优化表单流程，转化率提升 18%',
  '',
  '## 个人优势',
  '',
  '- 能把复杂需求拆成可交付的页面、接口和验收指标',
  '- 重视可读性、边界状态和上线后的真实使用反馈',
].join('\n') + '\n'
